...
Entity *addHouseEntity(GameState *state, float3 worldP, Animation *startAnimation = 0) {
    ...
    if(e) {
        ...
        easyAnimation_initController(&e->animationController);
		easyAnimation_addAnimationToController(&e->animationController, &state->animationState.animationItemFreeListPtr, (startAnimation) ? startAnimation : &state->houseAnimation, 0.08f);
...
Entity *addTowerEntity(GameState *state, float3 worldP, Animation *startAnimation = 0) {
    ...
    if(e) {
        ...
        easyAnimation_initController(&e->animationController);
		easyAnimation_addAnimationToController(&e->animationController, &state->animationState.animationItemFreeListPtr, (startAnimation) ? startAnimation : &state->towerAnimation, 0.08f);
